...
# Sustainable full-market transport profile: ~5 primary requests per 30s cycle.
s = s.replace('"POLL_SECONDS": str(POLL)', '"POLL_SECONDS": "30"', 1)
s = s.replace('"BATCH_SIZE": "100", "PRIMARY_WORKERS": "4", "RETRY_BATCH_SIZE": "40", "RETRY_WORKERS": "2", "SINGLE_FALLBACK_LIMIT": "5", "SESSION_POOL_SIZE": "4"', '"BATCH_SIZE": "400", "PRIMARY_WORKERS": "2", "RETRY_BATCH_SIZE": "100", "RETRY_WORKERS": "1", "SINGLE_FALLBACK_LIMIT": "2", "SESSION_POOL_SIZE": "2"', 1)
...
# With 30-second cycles, the guard window is one current full-market sample.
...
print('A4 V2.6 sustainable transport patch applied')
